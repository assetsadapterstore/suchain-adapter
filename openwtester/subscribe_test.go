...
func TestSubscribeAddress_SGU(t *testing.T) {

	var (
		endRunning = make(chan bool, 1)
		symbol     = "SGU"
		addrs = map[string]string{
			"STB9Cs3cCwoQ11TidumhAdcmvhLTZfHFUg": "STB9Cs3cCwoQ11TidumhAdcmvhLTZfHFUg",
		}
	)
	...
	scanner.SetRescanBlockHeight(328077)
