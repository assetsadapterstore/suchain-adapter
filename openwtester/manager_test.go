...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "Vz8386FzytVdoRwgAbuGkMGyRHR3Mmydzc")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "kencani1", WalletID: walletID, Required: 1, Symbol: "SGU", IsTrust: true}
